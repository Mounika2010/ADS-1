...
public class BST <Key extends Comparable <Key>, Value> {
    ...
    private class Node {
         ...
         * @param      value  The value
         */
        public  Node(Stockdata key, Frequency value) {
            this.key = key;
            this.value = value;
     ...
     * @param      value  The value
     */
    public void put(Stockdata key, Freuency value) {
     ...
     */
    public Node put(Node x, Stockadata key, String value ) {
     ...
     */
    public String get(Stockdata key) {
        Node x = root;
        while (x != null) {
            int cmp = key.compareTo(x.key);
            if(cmp < 0)  x =x.left;
